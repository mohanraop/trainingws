...
public class RegexMatching {
    ...
    public static void main(String args[]){
        ...
        System.out.println(rm.matchRegexRecursive("mohan".toCharArray(),"mohan".toCharArray()));
        System.out.println(rm.matchRegexRecursive("Tusha".toCharArray(),"mohan*a*b*".toCharArray()));
