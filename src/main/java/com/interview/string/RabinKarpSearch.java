...
public class RabinKarpSearch {
    ...
    public static void main(String args[]){
        ...
        System.out.println(rks.patternSearch("mohanrao".toCharArray(), "sharrao".toCharArray()));
        System.out.println(rks.patternSearch("mohanrao".toCharArray(), "rao".toCharArray()));
        System.out.println(rks.patternSearch("mohanrao".toCharArray(), "shas".toCharArray()));
        System.out.println(rks.patternSearch("mohanrao".toCharArray(), "usha".toCharArray()));
        System.out.println(rks.patternSearch("mohanrao".toCharArray(), "Tus".toCharArray()));
    }
}
